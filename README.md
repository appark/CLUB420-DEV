...
| **Desktop Location Picker** | ✅ **Active** | **Custom header component with black button design and elegant dropdown** |
| **Mobile Location Picker** | ✅ **Active** | **Mobile LOCATIONS menu styled as collapsible black button matching desktop exactly** |
...
9. **Divi Body Code**: Complete JavaScript must be added to Divi Theme Options → Integration → Body
...
2. **Required Plugins**: Install Code Snippets, WooCommerce, ensure Divi theme active
3. **PHP Snippets**: Add all 6 PHP snippets via Code Snippets plugin
4. **Desktop Header**: Add custom location picker component to header template
5. **Mobile Menu Setup**: 
...
6. **CSS Installation**: Add complete mobile menu CSS to Divi Custom CSS
7. **JavaScript Installation**: Add complete body JavaScript to Divi Theme Options → Integration → Body
8. **Divi Setup**: Add CSS classes to sections and menu items for store visibility
9. **Carousel Setup**: Add shortcodes to appropriate Davis/Dixon content sections
10. **Tymber Integration**: Ensure proxy pass is configured correctly
11. **Test Flow**: Verify age gate → store selection → content visibility → menu navigation
12. **Admin Setup**: Configure product schedules and monitor via dashboard

## 🛠️ **Installation Summary**

### **Required Files to Install:**
1. **PHP Snippets** (6 files) → WordPress Code Snippets plugin
2. **Complete Mobile Menu CSS** → Divi Custom CSS
3. **Complete Body JavaScript** → Divi Theme Options → Integration → Body
4. **Desktop Location Picker** → Header template or Divi header module
5. **Store Dropdown HTML** → Divi code modules where needed
...
### **Step 2: PHP Snippets Installation**
1. Go to **WordPress Admin → Snippets → Add New**
2. Add each of the 6 PHP snippets above:
...
### **Step 3: CSS Installation**
1. Go to **Divi → Theme Options → General → Custom CSS**
2. Add the **Complete Mobile Menu CSS** (above)
3. Save changes

### **Step 4: JavaScript Installation**  
1. Go to **Divi → Theme Options → Integration → Body**
2. Add the **Complete Body JavaScript** (above)
3. Save changes

### **Step 5: WordPress Menu Setup (CRITICAL)**
1. Go to **Appearance → Menus**
2. Create menu item **"LOCATIONS"** 
3. **ESSENTIAL:** Add CSS class: `dt-hide-on-desktop`
4. Add sub-items under LOCATIONS:
   - **Davis** (can link to # or be empty)
   - **Dixon** (can link to # or be empty)
5. Save menu

**IMPORTANT:** The LOCATIONS menu item MUST have the `dt-hide-on-desktop` CSS class for the mobile black button styling to work!

### **Step 6: Desktop Header Location Picker**
1. Add the **Desktop Location Picker HTML** to your header template
2. Include the **Desktop Location Picker CSS** in your theme styles
3. Add the **Desktop Location Picker JavaScript** to your theme

### **Step 7: Content Setup**
1. **Add CSS classes to Divi sections:**
   - `.davis-content` for Davis-only content
   - `.dixon-content` for Dixon-only content
   - `.davis-menu` for Davis-only menu items
   - `.dixon-menu` for Dixon-only menu items

2. **Add carousel shortcodes:**
   - Davis sections: `[club420_deals_carousel store="davis"]`
   - Dixon sections: `[club420_deals_carousel store="dixon"]`

3. **Add store dropdowns:**
   - Use the **Store Dropdown HTML** in Divi code modules
   - Give each dropdown a unique ID starting with `styled-store-select-`

### **Step 8: Product Configuration**
1. Edit WooCommerce products
2. Configure **Club420 Store Settings**:
   - Set visibility (Always/Scheduled/Disabled) for each store
   - Add store URLs for Tymber integration
   - Set schedules if using scheduled visibility

### **Step 9: Tymber Integration**
1. Configure proxy pass:
   - `/menu/f-street/` → Tymber Davis
   - `/menu/highway-80/` → Tymber Dixon
2. Ensure same-domain setup for localStorage sharing

### **Step 10: Testing Checklist**
- ✅ Age gate appears on first visit
- ✅ Store selection modal appears  
- ✅ **Desktop location picker shows as black button with white border**
- ✅ **Desktop dropdown works (Davis/Dixon side-by-side)**
- ✅ **Mobile LOCATIONS shows as BLACK BUTTON (not regular menu item)**
- ✅ **Mobile Davis/Dixon HIDDEN BY DEFAULT (not always visible)**
- ✅ **Mobile dropdown shows when LOCATIONS clicked (with arrow rotation)**
- ✅ **Mobile dropdown closes when Davis/Dixon selected**
- ✅ Store switching works on both desktop and mobile
- ✅ Content sections show/hide based on store
- ✅ Product carousels filter by store and schedule
- ✅ Menu navigation routes to Tymber correctly
- ✅ Page dropdowns sync with location pickers
...
### **localStorage Keys:**
- `tymber-user-has-allowed-age`: Cannabis compliance
- `last-store-selected`: User's preferred store

### **CSS Classes:**
- `.davis-content` / `.dixon-content`: Content sections
- `.davis-menu` / `.dixon-menu`: Menu items  
- `.dt-hide-on-desktop`: Mobile-only items

### **Dropdown Pattern:**
- IDs starting with `styled-store-select-*` are auto-detected

### **Text Menu Detection:**
- **FLOWER** → `/categories/flower/`
- **CARTRIDGES** → `/categories/cartridge/`
- **EDIBLES** → `/categories/edible/`
- **PRE-ROLLS** / **PREROLLS** → `/categories/preroll/`
- **EXTRACTS** / **EXTRACT** → `/categories/extract/`
- **SHOP ALL** / **ALL** / **SHOP NOW** → `/` (all products)

### **Proxy URLs:**
- Davis: `club420.com/menu/f-street/`
- Dixon: `club420.com/menu/highway-80/`

## 🔧 **Troubleshooting**

### **Mobile LOCATIONS not showing as black button:**
- ✅ Check that menu item has `dt-hide-on-desktop` CSS class
- ✅ Verify mobile menu CSS is installed correctly  
- ✅ Check browser console for JavaScript errors
- ✅ Ensure LOCATIONS has Davis and Dixon as sub-menu items
- ✅ Test on actual mobile device (not just browser resize)

### **Mobile LOCATIONS dropdown not working:**
- ✅ Verify complete body JavaScript is installed
- ✅ Check that mobile LOCATIONS JavaScript is loading (console logs)
- ✅ Ensure LOCATIONS menu item structure is correct
- ✅ Check for CSS conflicts with other mobile menu styling

### **Desktop location picker not working:**
- Ensure HTML component is added to header
- Verify CSS and JavaScript are included
- Check for conflicts with other header elements

### **Store switching not working:**
- Check browser localStorage for store ID values
- Verify `setStoreSmoothReload` function is available
- Check console for JavaScript errors

### **Content not showing/hiding correctly:**
- Verify CSS classes are applied to sections
- Check that localStorage contains correct store ID
- Ensure JavaScript body code is loaded

### **Carousels showing wrong products:**
- Check WooCommerce product store settings
- Verify scheduling settings and times
- Check if cache exclusion is working

---

**CLUB420 - Complete sophisticated cannabis retail system with unified location picking, real-time scheduling, and seamless Tymber integration** 🍃
...
### **PHP SNIPPET 2: Product URL Fields with Scheduler**
```php
...
### **PHP SNIPPET 3: Admin Store Filter**
```php
...
### **PHP SNIPPET 4: Auto-Button Generator**
```php
...
### **PHP SNIPPET 5: BlazeSlider Carousel**
```php
...
### **PHP SNIPPET 6: Scheduler Dashboard**
```php
...
### **COMPLETE BODY JAVASCRIPT (Divi Integration)**
```html
<!-- COMPLETE Club420 System - SMART AGE GATE WITH BOT DETECTION + SAFARI FIXES + MOBILE LOCATIONS -->
...
<script>
  ...
  // MOBILE LOCATIONS DROPDOWN - NEW FUNCTIONALITY 📱
  // Added in June 2025 - Makes mobile LOCATIONS work like desktop black button
  window.addEventListener('DOMContentLoaded', function() {
    setTimeout(function() {
      console.log('Club420: Initializing mobile LOCATIONS dropdown...');
      
      // Find mobile LOCATIONS menu item
      ...
      console.log('Club420: Found mobile LOCATIONS menu item');
      
      const locationsButton = mobileLocations.querySelector('a');
      const submenu = mobileLocations.querySelector('.sub-menu');
      
      if (!locationsButton || !submenu) {
        console.log('Club420: LOCATIONS button or submenu not found');
        return;
      }
      
      // Set initial button text based on current store
      const currentStore = localStorage.getItem('last-store-selected');
      if (currentStore === davisID) {
        locationsButton.childNodes[0].textContent = 'Davis ';
      } else if (currentStore === dixonID) {
        locationsButton.childNodes[0].textContent = 'Dixon ';
      } else {
        locationsButton.childNodes[0].textContent = 'Davis '; // Default
      }
      
      // Click LOCATIONS button to toggle dropdown
      locationsButton.addEventListener('click', function(e) {
        e.preventDefault();
        console.log('Club420: LOCATIONS button clicked');
        
        // Toggle dropdown
        mobileLocations.classList.toggle('open');
        
        if (mobileLocations.classList.contains('open')) {
          console.log('Club420: LOCATIONS dropdown opened');
          ...
          console.log('Club420: LOCATIONS dropdown closed');
          document.removeEventListener('click', closeOnClickOutside);
        }
      });
      
      // Handle Davis/Dixon clicks
      const storeLinks = submenu.querySelectorAll('.menu-item a');
      storeLinks.forEach(link => {
        link.addEventListener('click', function(e) {
          e.preventDefault();
          
          const locationName = this.textContent.trim();
          const store = locationName.toLowerCase();
          
          console.log('Club420: Mobile location selected:', locationName);
          
          if (store === 'davis' || store === 'dixon') {
            // Update button text
            locationsButton.childNodes[0].textContent = locationName + ' ';
            
            // Close dropdown
            mobileLocations.classList.remove('open');
            document.removeEventListener('click', closeOnClickOutside);
            
            // Use existing store switching system
            console.log('Club420: Using setStoreSmoothReload for mobile');
            setStoreSmoothReload(store);
          }
        });
      });
      ...
      // Close dropdown when clicking outside
      function closeOnClickOutside(event) {
        if (!mobileLocations.contains(event.target)) {
          mobileLocations.classList.remove('open');
          document.removeEventListener('click', closeOnClickOutside);
          console.log('Club420: LOCATIONS dropdown closed (click outside)');
        }
      }
      
      console.log('Club420: Mobile LOCATIONS dropdown initialized successfully! 📱');
      
    }, 1500); // Delay to ensure mobile menu is loaded
  });
  ...
  console.log('🍃 Club420: Complete system active - Age gate + Store switching + Mobile LOCATIONS dropdown! 📱🎯');
</script>
